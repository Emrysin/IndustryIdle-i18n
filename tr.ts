export const TR = {
    ...
    CircuitFoundry: "Elektronik Devre Üretim Tesisi",
    IntegratedCircuit: "Entegre Devre",
    OilWell: "Petrol Kuyusu",
    Wood: "Odun",
    LoggingCamp: "Kesim Sahası",
    ...
    FuelConsumption: "%{fuel} Tüketimi",
    FuelEconomy: "Yakıt Ekonomisi",
    FuelProduction: "%{fuel} Üretimi",
    FuelInStorage: "Depoda ki %{fuel}",
    Plastic: "Plastik",
    FuelSurplus: "%{fuel} Fazlası",
    Petrol: "Petrol",
    Buy: "Satın Al",
    NoLiquidity: "Likidide Yok",
    ...
    Copper: "Bakır",
    Gas: "Doğal Gaz",
    GasPump: "Doğal Gaz Pompası",
    GasPowerPlant: "Doğal Gaz Santrali",
    Missile: "Füze",
    MissileFactory: "Füze Fabrikası",
    Rocket: "Roket",
    RocketFactory: "Roket Fabrikası",
    BuildingPermit: "İnşaat Ruhsatı",
    BuildingPermitDesc:
